    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div class="text-sm text-gray-700 leading-relaxed space-y-2">
                <p>Μπορούν να αγωνίζονται αθλητές και αθλήτριες γεννημένοι/ες <strong>από το έτος 1997 και μεγαλύτεροι/ες</strong>, με την προϋπόθεση να μην είναι ενεργοί αθλητές/τριες.</p>
                <p>Δεν επιτρέπεται συμμετοχή αθλητή/τριας που κατά τις περιόδους 2024-25 και 2025-26 αγωνίστηκε σε πρωτάθλημα <strong>Α1, Α2 Εθνικής κατηγορίας ή Pre League</strong> Ανδρών και Γυναικών.</p>
                <div class="bg-blue-50 rounded-lg p-3 mt-2">
                    <p class="text-xs text-blue-800 font-medium mb-1">Διευκρινίσεις:</p>
                    <p class="text-xs text-blue-700">• Για γεννηθέντες/είσες το <strong>1995 και πριν</strong>: ελεύθερη συμμετοχή, δεν ισχύει κανένας περιορισμός.</p>
                    <p class="text-xs text-blue-700 mt-1">• Κατ' εξαίρεση επιτρέπεται συμμετοχή αθλητή/τριας γεννημένου/ης το <strong>1998 ή 1999</strong> αρκεί να υπάρχει μόνο ένας στην εξάδα.</p>
                </div>
            </div>
        </div>
